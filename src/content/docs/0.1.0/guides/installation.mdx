---
title: Installation
description: How to install nf-pediatric
...
Once everything installed and/or available, you can proceed to the [inputs section](/nf-pediatric/0.1.0/guides/inputs).
